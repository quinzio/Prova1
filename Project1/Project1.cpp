// Project1.cpp : Definisce il punto di ingresso dell'applicazione.
//
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   UpdateWindow(hWnd);
   CreateWindow(L"BUTTON", L"Button", BS_TEXT | WS_CHILD | WS_VISIBLE, 40, 40, 100, 40, hWnd, NULL, hInstance, NULL);
   CreateWindow(L"BUTTON", L"Button1", BS_TEXT | WS_CHILD | WS_VISIBLE, 100, 100, 100, 40, hWnd, NULL, hInstance, NULL);
   hwndTV = CreateWindow(
       L"TREEVIEW",
       L"Tree View",
