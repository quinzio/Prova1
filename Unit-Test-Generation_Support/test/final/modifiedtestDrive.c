...
static void initialise_expected_global_data(){
    ...
    COPY_TO_EXPECTED(ACM_SetFrequencySetPoint, expected_ACM_SetFrequencySetPoint);
...
static void check_global_data(){
    ...
    CHECK_MEMORY("_PWMDTY01", &_PWMDTY01, &expected__PWMDTY01, sizeof(expected__PWMDTY01));
    CHECK_MEMORY("_PWMDTY23", &_PWMDTY23, &expected__PWMDTY23, sizeof(expected__PWMDTY23));
    CHECK_MEMORY("_PWMDTY45", &_PWMDTY45, &expected__PWMDTY45, sizeof(expected__PWMDTY45));
    ...
    CHECK_MEMORY("strMachine", &strMachine, &expected_strMachine, sizeof(expected_strMachine));
    CHECK_ADDRESS(ACM_SetFrequencySetPoint, expected_ACM_SetFrequencySetPoint);
    CHECK_MEMORY("IbattReg", &IbattReg, &expected_IbattReg, sizeof(expected_IbattReg));
    CHECK_MEMORY("IbattStateMachine", &IbattStateMachine, &expected_IbattStateMachine, sizeof(expected_IbattStateMachine));
    CHECK_MEMORY("VectVarFilt", VectVarFilt, expected_VectVarFilt, sizeof(expected_VectVarFilt));
    CHECK_MEMORY("buffu16ADC_READING", buffu16ADC_READING, expected_buffu16ADC_READING, sizeof(expected_buffu16ADC_READING));
    CHECK_MEMORY("VectVarPI", VectVarPI, expected_VectVarPI, sizeof(expected_VectVarPI));
    CHECK_U_INT(u16VbattAvg, expected_u16VbattAvg);
    CHECK_MEMORY("VectParPI", VectParPI, expected_VectParPI, sizeof(expected_VectParPI));
    CHECK_U_CHAR(u8WMerrCounts, expected_u8WMerrCounts);
    CHECK_MEMORY("rampGenerator", &rampGenerator, &expected_rampGenerator, sizeof(expected_rampGenerator));
...
{
    test_ACM_Init(1);
    test_ACM_InitOnFly(1);
    test_ACM_ManageParking(1);
    test_ACM_InitControlStruct(1);
    test_ACM_UpdateControlStruct(1);
    test_ACM_DoMotorControl(1);
    test_ACM_DoFrequencyRampPU(1);
	test_ACM_DoFrequencyRampPU_001(1);
	test_ACM_DoFrequencyRampPU_002(1);
    test_ACM_GetMaximumVoltageApp(1);
    test_ACM_SetVoltageVoverF(1);
    test_ACM_RsTempCorr(1);
    test_ACM_ComputeDeltaMax(1);
    test_ACM_ComputeDeltaAngle(1);
    test_ACM_WindMillLoop(1);
    test_ACM_DeltaLimiterLoop(1);
    test_ACM_MaxIpkLoop(1);
    test_ACM_MaxPbattLoop(1);
    test_ACM_TODLoop(1);
    test_ACM_PhaseVoltageLoop(1);
    test_ACM_CheckWindmillRecovery(1);
    test_SetFrequencySetPoint(1);
    test_ACM_SetFrequencySetPointFixed(1);
    test_ACM_Set_u16FreqRampPU(1);
    test_ACM_Get_u16FreqRampPU(1);
    test_ACM_Set_u16FreqRampSmoothPU(1);
    test_ACM_Get_u16FreqRampSmoothPU(1);
    test_ACM_ManagePulseCanc(1);
    ...
    if (doIt) {
	 ...
	 u16NewFreqPU = 13;
        ...
        initialise_expected_global_data();
        	 expected_VectVarFilt[0].s16NewOutput = 97;
	 ...
	 expected_BOOLSteadyStateFlag = 1;
        ...
        EXPECTED_CALLS(
        	"ACM_Get_u16FreqRampPU"		"#s_r_12;"
	"Temp_Get_BOOLSOATemperatureCorr"		"#s_r_0;"
	"ACM_Get_u16FreqRampPU"		"#s_r_99;"
	"FIR_UpdateFilt"		"#s_r_98_p_0_p_49;"
	"ACM_Set_u16FreqRampSmoothPU"		"#s_r_96_p_194;"
...
void test_ACM_DoFrequencyRampPU_001(int doIt) {
    if (doIt) {
        ...
        /* Set global data */
        initialise_global_data();
        	 VectVarFilt[0].s16NewOutput = 8;
	 IbattReg.u16IbattRegOut = 11;
	 IbattStateMachine.BOOLForceGainFlag = 1431655765;
	 BOOLSteadyStateFlag = 1431655765;
	 u16NewFreqPU = 115;
        ...
        /* Set expected values for global data checks */
        initialise_expected_global_data();
        	 expected_VectVarFilt[0].s16NewOutput = 8;
	 expected_IbattReg.u16IbattRegOut = 11;
	 expected_IbattStateMachine.BOOLForceGainFlag = 0;
	 expected_BOOLSteadyStateFlag = 1;
        ...
        /* Expected Call Sequence  */
        EXPECTED_CALLS(
        	"ACM_Get_u16FreqRampPU"		"#s_r_111;"
	"Temp_Get_BOOLSOATemperatureCorr"		"#s_r_11;"
	"ACM_Get_u16FreqRampPU"		"#s_r_2;"
	"FIR_UpdateFilt"		"#s_r_9_p_0_p_1;"
	"ACM_Set_u16FreqRampSmoothPU"		"#s_r_7_p_16;"
...
if (doIt) {
    ...
    START_TEST("test_ACM_Init",
               "<Insert test case description here>");

        /* Expected Call Sequence  */
        EXPECTED_CALLS("{{MTC_ResetZCECntrl#default}{MTC_InitMTCVariables#default}{Tacho_InitTachoVariables#default}{MTC_InitBatteryDegragation#default}{ACM_InitControlStruct#default}{Power_InitPowerStruct#default}{REG_SetParPI#default}{REG_InitVarPI#default}{FIR_SetParFilt#default}{ACM_Get_u16FreqRampPU#default}{FIR_InitVarFilt#default}}");
...
if (doIt) {
    ...
    START_TEST("test_ACM_InitOnFly",
               "<Insert test case description here>");

        /* Expected Call Sequence  */
        EXPECTED_CALLS("{{Power_InitPowerStruct#default}{RVP_SetRVPOn#default}{MTC_InitBatteryDegragation#default}{REG_SetParPI#default}{REG_InitVarPI#default}{FIR_SetParFilt#default}{ACM_Get_u16FreqRampPU#default}{FIR_InitVarFilt#default}}");
...
if (doIt) {
    ...
    START_TEST("test_ACM_ManageParking",
        ...
        /* Expected Call Sequence  */
        EXPECTED_CALLS("{{TLE_EnableOutputs#default}{INT0_PWM_FailSafeMonitor#default}{WTD_ResetWatchdog#default}{INT0_PWM_FailSafeMonitor_rst#default}{RVP_SetRVPOn#default}{InputSP_GetOperatingMode#default}{RTI_SetMainTimeBase#default}{RTI_IsMainTimeElapsed#default}{INT0_FailSafeMonitor#default}{DIAG_ManageDiagnosticToECU#default}{INT0_FailSafeMonitor_rst#default}{MTC_SettingForParkingPhase#default}{Tacho_ResetTachoOverflowNumber#default}{MTC_ParkAngleSweep#default}}");
...
if (doIt) {
    ...
    START_TEST("test_ACM_InitControlStruct",
        ...
        /* Expected Call Sequence  */
        EXPECTED_CALLS("{{ACM_Set_u16FreqRampPU#default}{MTC_ComputeParkingTime#default}{ACM_Get_u16FreqRampPU#default}{ACM_Set_u16FreqRampSmoothPU#default}{ACM_Get_u16FreqRampSmoothPU#default}}");
...
if (doIt) {
    ...
    START_TEST("test_ACM_UpdateControlStruct",
        ...
        /* Expected Call Sequence  */
        EXPECTED_CALLS("{{ACM_Set_u16FreqRampPU#default}{ACM_Get_u16FreqRampPU#default}{ACM_Set_u16FreqRampSmoothPU#default}{ACM_Get_u16FreqRampSmoothPU#default}}");
...
if (doIt) {
    ...
    START_TEST("test_ACM_DoMotorControl",
        ...
        /* Expected Call Sequence  */
        EXPECTED_CALLS("{{RTI_IsRegPeriodElapsed#default}{InputSP_GetInputSetPoint#default}{ACM_DoFrequencyRampPU#default}{MaxPower_PowerSetPoint#default}{ACM_ManagePulseCanc#default}{Tacho_ManageTachoCapture#default}{ACM_ComputeDeltaAngle#default}{Power_UpdatePowerStruct#default}{ACM_WindMillLoop#default}{ACM_DeltaLimiterLoop#default}{ACM_MaxPbattLoop#default}{ACM_SetVoltageVoverF#default}{ACM_MaxIpkLoop#default}{ACM_TODLoop#default}{ACM_PhaseVoltageLoop#default}{MTC_UpdateSine#default}}");
...
if (doIt) {
    ...
    START_TEST("test_ACM_DoFrequencyRampPU",
        ...
        /* Expected Call Sequence  */
        EXPECTED_CALLS("{{ACM_Get_u16FreqRampPU#default}{Temp_Get_BOOLSOATemperatureCorr#default}{ACM_Set_u16FreqRampPU#default}{FIR_UpdateFilt#default}{ACM_Set_u16FreqRampSmoothPU#default}}");
...
if (doIt) {
    ...
    START_TEST("test_ACM_ComputeDeltaAngle",
        ...
        /* Expected Call Sequence  */
        EXPECTED_CALLS("{{ACM_GetMaximumVoltageApp#default}{Curr_GetPeakCurrent#default}}");
...
if (doIt) {
    ...
    START_TEST("test_ACM_WindMillLoop",
        ...
        /* Expected Call Sequence  */
        EXPECTED_CALLS("{{FIR_UpdateFilt#default}{ACM_Get_u16FreqRampPU#default}{REG_UpdateInputPI#default}{REG_SetParPI#default}{REG_UpdateRegPI#default}{ACM_CheckWindmillRecovery#default}{Main_SetBit_u16ErrorType#default}{Main_ClrBit_u16ErrorType#default}{ACM_Get_u16FreqRampSmoothPU#default}}");
...
if (doIt) {
    ...
    START_TEST("test_ACM_DeltaLimiterLoop",
        ...
        /* Expected Call Sequence  */
        EXPECTED_CALLS("{{ACM_GetMaximumVoltageApp#default}{REG_SetParPI#default}{FIR_UpdateFilt#default}{ACM_Get_u16FreqRampPU#default}{REG_UpdateInputPI#default}{ACM_ComputeDeltaMax#default}{REG_UpdateRegPI#default}}");
...
if (doIt) {
    ...
    START_TEST("test_ACM_MaxIpkLoop",
        ...
        /* Expected Call Sequence  */
        EXPECTED_CALLS("{{REG_UpdateInputPI#default}{REG_UpdateRegPI#default}}");
...
if (doIt) {
    ...
    START_TEST("test_ACM_MaxPbattLoop",
        ...
        /* Expected Call Sequence  */
        EXPECTED_CALLS("{{REG_UpdateInputPI#default}{MaxPower_GetPowerSetPoint#default}{Power_Get_structPowerMeas_u32PbattPU#default}{REG_UpdateRegPI#default}{Temp_Get_BOOLSOATemperatureCorr#default}}");
...
if (doIt) {
    ...
    START_TEST("test_ACM_TODLoop",
               "<Insert test case description here>");

        /* Expected Call Sequence  */
        EXPECTED_CALLS("{{FIR_UpdateFilt#default}{Power_Get_structPowerMeas_u32PbattPU#default}{REG_UpdateInputPI#default}{REG_SetParPI#default}{REG_UpdateRegPI#default}}");
...
if (doIt) {
    ...
    START_TEST("test_ACM_PhaseVoltageLoop",
        ...
        /* Expected Call Sequence  */
        EXPECTED_CALLS("{{ACM_Get_u16FreqRampPU#default}{REG_SetParPI#default}{REG_UpdateInputPI#default}{Curr_GetCurrent#default}{REG_UpdateRegPI#default}{MTC_GetScaledVoltage#default}{ACM_GetMaximumVoltageApp#default}}");
...
if (doIt) {
    ...
    START_TEST("test_ACM_CheckWindmillRecovery",
        ...
        /* Expected Call Sequence  */
        EXPECTED_CALLS("{{MTC_GetScaledVoltage#default}{EMR_EmergencyDisablePowerStage#default}}");
...
void REG_SetParPI(PIenum enumReg,
                  u16 u16IntGain,
                  u16 u16PropGain,
                  s32 s32RegLimLow,
                  s32 s32RegLimHigh,
...
void REG_InitVarPI(PIenum enumReg,
                   s16 s16RegInput,
                   s16 s16RegFeedback,
                   s32 s32Integral,
                   s32 s32Proportional,
...
void FIR_SetParFilt(FiltEnum enumFilt,
                    u16 u16SampleFreq,
                    u16 u16PoleFreq,
                    u16 u16ZeroFreq,
                    s16 s16Hyst,
...
void FIR_InitVarFilt(FiltEnum enumFilt,
                     s16 s16OldInput,
                     s16 s16NewOutput){
...
void DIAG_ManageDiagnosticToECU(SystStatus_t enLocState,
                                u16 u16DiagErrorType){
...
BOOL MTC_UpdateSine(u16 u16NewVoltage,
                    u16 u16NewFrequency){
...
void FIR_UpdateFilt(FiltEnum enumFilt,
                    s16 s16NewInput){
...
void REG_UpdateInputPI(PIenum enumReg,
                       s16 s16RegSp,
                       s16 s16RegSample){
...
u16 AFTER_SetFrequencySetPoint(u16 cppsm_return_value,
                               u8 u8InRef){
    IF_INSTANCE("default") {
        return cppsm_return_value;
    }
